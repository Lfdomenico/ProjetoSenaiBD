...
public class FuncionarioException extends Exception {
    ...
    public Funcionario CadastroException(String nome, String cpf, String genero, Setor setorSelecionado) {
        ...
        try {
            // Agora passa o salário como null ou um objeto Salario válido
            Salario salario = null; // Ou use um valor inicial, se necessário
            return new Funcionario(nome, cpf, genero, setorSelecionado, salario);
        } catch (FuncionarioException e) {
            e.printStackTrace();
            return null; // Você pode querer lançar uma exceção aqui ou tratar de outra maneira
        }
    }
